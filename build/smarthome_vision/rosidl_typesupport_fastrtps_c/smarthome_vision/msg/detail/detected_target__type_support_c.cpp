...
#include "smarthome_vision/msg/detail/detected_target__rosidl_typesupport_fastrtps_c.h"
...
#include "smarthome_vision/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // corners_uv
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // corners_uv

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_smarthome_vision
...
using _DetectedTarget__ros_msg_type = smarthome_vision__msg__DetectedTarget;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: corners_uv
  {
    size_t size = ros_message->corners_uv.size;
    auto array_ptr = ros_message->corners_uv.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: corners_uv
  {
    ...
    if (ros_message->corners_uv.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->corners_uv);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->corners_uv, size)) {
      fprintf(stderr, "failed to create array for field 'corners_uv'");
      return false;
    }
    auto array_ptr = ros_message->corners_uv.data;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smarthome_vision
size_t get_serialized_size_smarthome_vision__msg__DetectedTarget(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DetectedTarget__ros_msg_type * ros_message = static_cast<const _DetectedTarget__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DetectedTarget__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smarthome_vision__msg__DetectedTarget(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smarthome_vision
size_t max_serialized_size_smarthome_vision__msg__DetectedTarget(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarthome_vision__msg__DetectedTarget;
    is_plain =
      (
...
static size_t _DetectedTarget__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smarthome_vision__msg__DetectedTarget(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smarthome_vision, msg, DetectedTarget)() {
